...
use aiwm_core::api::dto::{
    ...
    NewAgentDto, NewSessionDto, NpcBodyDto, OpenAgentSessionDto, RegisterColibriModelDto,
    RegistryDetailsDto, RegistrySearchDto, RuntimeStatusDto, SceneBodyDto, SceneDetailDto,
    StoryBodyDto, SubmitJobDto,
};
...
use aiwm_core::db::{
    ...
    Job, JobFilter, Location, Model, Npc, SceneImage, Session, Story,
};
