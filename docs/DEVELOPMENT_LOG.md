# AI Workstation Manager — Entwicklungslog

> Dies war die frühere `README.md` (bis 2026-09-21). Die Produktbeschreibung steht jetzt in der
> [README](../README.md); hier bleibt der vollständige Verlauf der Phasen und Scheiben.
...
**411 Rust-Unit + 58 Integrationstests + 5 pytest** grün · `scripts/check.ps1` grün ·
...
[docs/PHASE_3_PLAN.md](PHASE_3_PLAN.md). Offen: cu130-Treiber-Check auf der
...
der echten Maschine. Plan + Research: [docs/PHASE_4_PLAN.md](PHASE_4_PLAN.md).
**Phase 5 (Agents) — Plan + 5.0 + 5.1a + 5.1b + 5.1c + 5.2 + 5.3 + 5.4 + 5.5 ✅:** [docs/PHASE_5_PLAN.md](PHASE_5_PLAN.md),
...
- **5.1cb** ✅ **Agent-API**: `App.agents` + API `GET/POST /agents`,
  ...
  `ipc.ts`-Bindings. [`docs/AGENT_MODELS.md`](AGENT_MODELS.md) — kuratierte
...
**Phase 6 (Automatisierung & Model-Manager v2) ✅ abgeschlossen — Scheiben 6.0–6.9:** [docs/PHASE_6_PLAN.md](PHASE_6_PLAN.md).
...
- **Post-6.9 Politur** — `scripts/start.ps1`/`install.ps1` (Dev-Launcher +
  ...
  **kategorisierter Models-Tab**: „Recommended models" in vier Reitern
  ...
  (kuratierte Chat-/Coding-HF-Repos aus [AGENT_MODELS.md](AGENT_MODELS.md)),
...
- **4.4** ✅ **Zweites Video-Template**: `pipeline::ltx_video` — **LTX-Video 0.9.5
  ...
  [`docs/VIDEO_MODELS.md`](VIDEO_MODELS.md) · **ADR-020** (Abweichung vom
...
- **3.6** ✅ **Flux als zweites Template**: `core::pipeline` trägt jetzt
  ...
  · „Known models"-Panel im Models-Tab · [`docs/IMAGE_MODELS.md`](IMAGE_MODELS.md).
...
Setup (einmalig): [docs/DEV_SETUP.md](DEV_SETUP.md).
...
| Datei | Inhalt |
|---|---|
| [docs/ANALYSIS.md](ANALYSIS.md) | Kritische Analyse des Briefs: Lücken, Widersprüche, unrealistische Erwartungen |
| [docs/PRODUCT_VISION.md](PRODUCT_VISION.md) | Produktvision, Leitprinzipien, Nicht-Ziele |
| [docs/ARCHITECTURE.md](ARCHITECTURE.md) | Systemarchitektur, Komponenten, Datenmodell, Abstraktionen |
| [docs/TECHNOLOGY.md](TECHNOLOGY.md) | Technologievergleich mit Offline/Cloud/Account/OSS-Matrix |
| [docs/HARDWARE.md](HARDWARE.md) | Realistische Modell-/Auflösungs-/Geschwindigkeitseinschätzung für die Hardware |
| [docs/ROADMAP.md](ROADMAP.md) | MVP-Definition und Phasenplan |
| [docs/PHASE_1_PLAN.md](PHASE_1_PLAN.md) | Detailplan + Ergebnisse aller Phase-1-Arbeitspakete |
| [docs/PHASE_2_PLAN.md](PHASE_2_PLAN.md) | Phase-2-Scheibenplan + Fortschritt |
| [docs/PHASE_3_PLAN.md](PHASE_3_PLAN.md) | Phase-3-Scheibenplan (Bild / ComfyUI) + Research + Ergebnisse |
| [docs/PHASE_4_PLAN.md](PHASE_4_PLAN.md) | Phase-4-Scheibenplan (Video) + Research |
| [docs/PHASE_5_PLAN.md](PHASE_5_PLAN.md) | Phase-5-Scheibenplan (Agents: OpenCode + Hermes) + Research |
| [docs/VIDEO_MODELS.md](VIDEO_MODELS.md) | Video-Modelle — kuratierte Liste (Wan 2.2, LTX-Video) |
| [docs/AGENT_MODELS.md](AGENT_MODELS.md) | Agent-Coding-GGUFs (`coding`-Rolle, Tool-Calling) + manuelle Smoke-Prozedur |
| [docs/DEV_SETUP.md](DEV_SETUP.md) | Toolchain-Installation, Build-/Test-Befehle, Git-Hooks, CI |
| [docs/DECISIONS.md](DECISIONS.md) | Architecture Decision Records (ADRs) |
| [docs/RISKS.md](RISKS.md) | Risikoregister mit Gegenmaßnahmen |
| [docs/MODELS.md](MODELS.md) | Modell-Verwaltung: Stand + Plan |
| [docs/IMAGE_MODELS.md](IMAGE_MODELS.md) | Kuratierte Bild-Modelle (SDXL, Flux-Stack): Quelle, SHA-256, Lizenz, Settings |
| [docs/RUNTIMES.md](RUNTIMES.md) | Runtime-Abstraktion + Integrationsstand |
| [docs/SECURITY.md](SECURITY.md) | Sicherheitsmodell (Loopback-only, Prozess-Isolation, Agent-Sandbox) |
| [docs/BENCHMARKS.md](BENCHMARKS.md) | Benchmark-Konzept (Phase 6) |
| [docs/TODO.md](TODO.md) | Parkplatz für zurückgestellte Punkte |
